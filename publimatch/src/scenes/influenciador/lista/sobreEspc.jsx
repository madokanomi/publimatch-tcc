    ...
    return (
        <Box pr={3} pl={3}>
                            ...
                            <Box display="flex" gap={2} flex={1}>
                                ...
                                <Box>
                                    ...
                                    <Box display="flex" gap={1}>
                                        {social.youtube && (
                                            <Box sx={{ width: 32, height: 32, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", "&:hover": { backgroundColor: "rgba(255,255,255,0.3)" } }} onClick={() => window.open(social.youtube, '_blank')} >
                                                <YouTubeIcon sx={{ fontSize: 16 }} />
                                            </Box>
                                        )}
                                        {social.instagram && (
                                            <Box sx={{ width: 32, height: 32, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", "&:hover": { backgroundColor: "rgba(255,255,255,0.3)" } }} onClick={() => window.open(social.instagram, '_blank')} >
                                                <InstagramIcon sx={{ fontSize: 16 }} />
                                            </Box>
                                        )}
                                        {social.twitch && (
                                            <Box sx={{ width: 32, height: 32, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", "&:hover": { backgroundColor: "rgba(255,255,255,0.3)" } }} onClick={() => window.open(social.twitch, '_blank')} >
                                                <SiTwitch sx={{ fontSize: 16 }} />
                                            </Box>
                                        )}
                                        {social.tiktok && (
                                            <Box sx={{ width: 32, height: 32, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", "&:hover": { backgroundColor: "rgba(255,255,255,0.3)" } }} onClick={() => window.open(social.tiktok, '_blank')} >
            ...
            <Dialog open={openHireDialog} onClose={handleCloseHireDialog} sx={{ "& .MuiPaper-root": { backgroundColor: "rgba(225, 225, 225, 0.33)", color: "#FFFFFF", backdropFilter: "blur(10px)", borderRadius: "20px", border: "1px solid rgba(255, 255, 255, 0.2)", }, }} >
                <DialogTitle id="hire-dialog-title" sx={{ fontWeight: "bold" }}> Contratar Influenciador </DialogTitle>
                <DialogContent>
            ...
            <Dialog open={openFinalizeDialog} onClose={handleCloseFinalizeDialog} sx={{ "& .MuiPaper-root": { backgroundColor: "rgba(255, 255, 255, 0.26)", color: "#FFFFFF", backdropFilter: "blur(20px)", borderRadius: "20px", border: "1px solid rgba(255, 255, 255, 0.2)", }, }} >
                ...
                <DialogContent>
                    ...
                    <TextField autoFocus margin="dense" id="password" label="Senha" type="password" fullWidth variant="filled" value={password} onChange={(e) => setPassword(e.target.value)} sx={{ "& .MuiFilledInput-root": { backgroundColor: "rgba(0, 0, 0, 0.2)", borderRadius: "10px", }, "& .MuiInputLabel-root": { color: "rgba(255, 255, 255, 0.7)" }, "& .MuiFilledInput-input": { color: "white" }, }} />
                </DialogContent>
                <DialogActions sx={{ p: "0 24px 16px" }}>
                    <Button onClick={handleCloseFinalizeDialog} sx={{ color: "rgba(255, 255, 255, 0.7)" }} > Cancelar </Button>
                    <Button onClick={handleConfirmFinalize} disabled={!password} autoFocus sx={{ fontWeight: "bold", color: "#d900c7", backgroundColor: "#ffffffff", "&:hover": { backgroundColor: "#e9e9e9ff" }, "&.Mui-disabled": { backgroundColor: "rgba(255, 255, 255, 0.5)" }, }} > Solicitar Finalização </Button>
                </DialogActions>
            </Dialog>
