...
const CampaignProfile = () => {
    ...
    // 1. Estados para os dados da API, carregamento e erro
    ...
    // 2. useEffect para buscar os dados da campanha na API
    useEffect(() => {
        if (!user) return;
    ...
    // Definições de animação (mantidas como no seu código original)
    ...
    if (!campaign) return null; // Não renderiza nada se a campanha for nula após o loading
    ...
    const renderTabContent = () => {
        // A lógica das abas permanece a mesma, passando o 'campaign' real
        switch (activeTab) {
                                ...
                                <Box display="flex" alignItems="center" justifyContent="space-between">
                                    <Box>
                                        ...
                                        {!isAboutOnlyView && (
                                            ...
                                            <MenuItem key={s} onClick={() => { setAnchorEl(null); /* Lógica para ATUALIZAR status no backend viria aqui */ }}>{s}</MenuItem>
                                        ))}
                                            </Menu>
                                        )}
                                    </Box>
